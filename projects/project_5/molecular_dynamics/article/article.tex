...
We initially decided to use the Velocity-Verlet integration method as opposed
to Euler-Cromer for its good energy conservation. We now simulate a set of
similar systems with varying temperature and look at how the fluctuations in
total energy scales with the timestep $\Delta T$. In order to do this we can
consider the standard-devation of the total energy.
